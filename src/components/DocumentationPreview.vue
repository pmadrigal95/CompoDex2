        ...
        <div v-else class="p-6">
            ...
            <section class="mb-6">
                ...
                <div v-if="props.length > 0" class="grid gap-2">
                    <div v-for="(prop, i) in props" :key="prop" class="p-3 bg-muted/50 rounded-md" v-motion
                        :initial="{ opacity: 0, y: 10 }" :enter="{ opacity: 1, y: 0 }" :transition="{ delay: i * 50 }">
                        <div class="flex items-center justify-between">
            ...
            <section class="mb-6">
                ...
                <div v-if="emits.length > 0" class="grid gap-2">
                    <div v-for="(emit, i) in emits" :key="emit" class="p-3 bg-muted/50 rounded-md" v-motion
                        :initial="{ opacity: 0, y: 10 }" :enter="{ opacity: 1, y: 0 }" :transition="{ delay: i * 50 }">
                        <div class="flex items-center justify-between">
